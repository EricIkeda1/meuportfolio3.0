      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <motion.h1
              className="text-5xl lg:text-7xl tracking-tight font-bold mt-8 sm:mt-0" 
            ...
            >
              ...
              <motion.span
                className="ml-1"
                style={{ display: "inline-block", opacity: cursorVisible ? 1 : 0 }}
              >
                |
              </motion.span>
            </motion.h1>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
              Estudante de <strong>Engenharia de Software</strong> no UniSenaiPR em Londrina Paraná, desde 2021,
